...
namespace MyBGList.Models.Csv
{
    ...
    public class BakingRecordMap
    {
        ...
        [Name("OrderBakingGood_BakingGoodId")]
        public int OrderBakingGoodBakingGoodId { get; set; }

        [Name("OrderBakingGood_Quantity")]
        public int OrderBakingGoodQuantity { get; set; }

        // for BakingGoodBatch
        [Name("BakingGoodBatch_BakingGoodId")]
        public int BakingGoodBatchBakingGoodId { get; set; }
